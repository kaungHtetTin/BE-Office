		...
		<div class="sa4d25">
			<div class="container-fluid">	
				...
				<div class="row">
                    ...
                    <div class="col-lg-4">            
                        <div class="card_dash">
                            <h4> <?php echo $customer['customer_name'];?> </h4><br>
                            <p>Phone - <?php echo $customer['customer_phone'];?> </p><br>
                            <p>Address -<?php echo $customer['customer_address'];?> </p>
                            <br><br>

                            <a href="create_invoice.php?phone=<?php echo $phone ?>" style="font-size:14px;">New Sale</a>
                     ...
                     <div class="col-lg-8">
                        ...
                        <?php if($sales){ ?>
                            <div style="display:flex;">
                                <?php if($page>1){ ?> 
                                <a href="?page=<?php echo ($page-1).'&phone='.$phone ?>" class="pagination menu--link"><< Previous</a>
                                <?php }?>
                                <span class="pagination menu--link"><?php echo $page ?></span>
                                <?php if($sales){ ?>
                                    <a href="?page=<?php echo ($page+1).'&phone='.$phone ?>" class="pagination menu--link">Next >></a>
                                <?php }?>
