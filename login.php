...
if($_SERVER['REQUEST_METHOD']=="POST"){
	...
	$auth_result=$Login->loginUser($email,$password);
	if($auth_result['auth']=="success"){
		$_SESSION['beoffice_userid']=$auth_result['user_id'];
		$_SESSION['beoffice_auth_token']=$auth_result['auth_token'];
...
<html lang="en">
	...
	<head>
		...
		<title>Billion Empress | Login</title>
			...
			<div class="row justify-content-lg-center justify-content-md-center">
				...
				<div class="col-lg-6 col-md-8">
					<div class="sign_form">
						...
						<h2>Welcome Back</h2>
						<p>Log In to Your Billion Empress Account!</p>
						...
						<form action="" method="POST">
							...
							<br><br>
							<?php if($auth_result!="" && $auth_result['auth']=="fail"){ ?>
								<span style="color:red"> <?php echo $auth_result['error'] ?>  </span>
							<?php }?>
							<button class="login-btn" type="submit">Sign In</button>
							
						</form>
						<p class="sgntrm145">Or <a href="forgot_password.html">Forgot Password</a>.</p>
						<p class="mb-0 mt-30 hvsng145">Don't have an account? <a href="sign_up.php">Sign Up</a></p>
					</div>
