...
class Factory{
    public function sentOrder($data){
        ...
        $query1="insert into businesses (agent_id,voucher_id,total_amount,group_id,seen,is_sold_out) values
        ($agent_id,$voucher_id,$total_amount,$group_id,1,1)
        ";
        $DB=new Database();
        $DB->save($query1);
        ...
        for($i=0;$i<count($products);$i++){
            ...
            $query2="insert into business_details (voucher_id,product_id,quantity,foc,amount,price) values
            ($voucher_id,$product_id,$quantity,$foc,$amount,$price)
            ";
            $DB->save($query2);
